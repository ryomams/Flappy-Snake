...
3. Using CMake from the command line, run
  ...
  cmake --build build
  ```
  and also make sure your working directory is the project you unzipped or cloned...<br>If you're on linux, [you'll need to install SFML's dependencies]([https://github.com/SFML/cmake-sfml-project?tab=readme-ov-file](https://github.com/SFML/cmake-sfml-project?tab=readme-ov-file#how-to-use)).
